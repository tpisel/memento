...
- V0 can expose and exercise the future agent-facing write surface without taking on all editing semantics immediately.
...
- The eventual write API still has a clear destination: mechanically enforce declared modes before mutating files.
